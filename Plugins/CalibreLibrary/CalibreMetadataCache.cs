...
public class CalibreMetadataCache
{
    public CalibreMetadataCache(IPersistentDirectory<CalibreMetadataCache> cacheDir, ILogger<CalibreMetadataCache> logger)
    {
    ...
    private readonly IPersistentDirectory<CalibreMetadataCache> cacheDir;
    private readonly ILogger<CalibreMetadataCache> logger;
